    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActionTakenID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionTakens", x => x.ActionTakenID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActionMessageID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ActionTakenID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionMessages", x => x.ActionMessageID);
                    table.ForeignKey(
                        name: "FK_ActionMessages_ActionTakens_ActionTakenID",
                        column: x => x.ActionTakenID,
                        principalTable: "ActionTakens",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Logins_LoginID",
                        column: x => x.LoginID,
                        principalTable: "Logins",
                        principalColumn: "LoginID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionMessages_ActionTakenID",
                table: "ActionMessages",
